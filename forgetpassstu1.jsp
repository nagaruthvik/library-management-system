...
ResultSet rs =stmt.executeQuery("select * from student_info where regid='"+regid+"'and fir_school='"+fschool+"'");
if(rs.next()){
	
	pageContext.setAttribute("regid", regid,pageContext.SESSION_SCOPE);
