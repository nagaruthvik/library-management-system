...
<body>
<% 
String regid=(String)pageContext.getAttribute(("regid"),pageContext.SESSION_SCOPE);
...
if(password.equals(cpassword)){
	...
	if(rs.next()){
		int result =stmt.executeUpdate("UPDATE student_info set password='"+password+"' WHERE regid='"+regid+"'");
		if(result>0){
			...
			response.sendRedirect("forgetpassstu.jsp.jsp");
		}
	}
	else{
		...
		response.sendRedirect("forgetpassstu.jsp");
	}
}
else{
	...
	response.sendRedirect("forgetpassstu2.jsp");
}
%>
